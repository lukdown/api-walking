...
public class YdsVo {
	...
	public YdsVo(int gallery_no, int course_no, int users_no, String users_nickname, String users_orgName,
			String users_saveName, String users_filePath, long users_fileSize, YdsAttachVo gallery_attach,
